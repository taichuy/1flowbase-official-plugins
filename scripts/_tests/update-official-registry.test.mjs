...
test('upsertRegistryEntry removes stale and foreign entries for the same provider_code', () => {
  const registry = {
    version: 1,
    generated_at: '2026-04-18T00:00:00.000Z',
    plugins: [
  ...
  const next = upsertRegistryEntry(registry, {
    ...
    download_url:
      'https://github.com/taichuy/1flowbase-official-plugins/releases/download/openai_compatible-v0.2.0/pkg.1flowbasepkg',
  ...
  assert.equal(next.plugins[0].latest_version, '0.2.0');
});
